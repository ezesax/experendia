...
<head>
  <meta charset="UTF-8">
  <title>Experendia | Cuenta verificada</title>
        ...
        <article class="col-xs-12 col-md-6 padding_messages_send" style="margin: auto">
          <div class="cnt_main_contact" style="text-align: center;">
            <div style="margin:auto">
              <img src="images/registro.gif" alt="" width="186px" height="112px">
            </div>
            <b style="font-size:24px; line-height:60px;">¡Felicitaciones!</b>
            <span class="text-14" style="display: block">
            Ya eres usuario de Experendia.
            </span>
          </div>
          <div class="text-center text-muted" style="margin: 0 auto 30px;font-size: 16px">
          <b>Descubre grandes experiencias en los canales de tu interés.</b>
          </div>
          <div class="col-12" style="overflow: hidden;margin:  0 0 40px 0">
            <div class="btns_channels_contact">
              <a href="#">Experiencias <br> de Vida  ›</a>
            </div>
            <div class="btns_channels_contact">
              <a href="#">Experiencias <br> del Conocimiento  ›</a>
            </div>
            <div class="btns_channels_contact">
              <a href="#">Experiencias <br> de Negocios y Marcas  ›</a>
            </div>
          </div>
        </article>
        <!---****************************** START ASIDE**************************************-->
