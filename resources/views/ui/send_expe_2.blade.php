...
<head>
  <meta charset="UTF-8">
  <title>Experendia | Confirmación de correo electrónico</title>
        ...
        <article class="col-xs-12 col-md-6 padding_messages_send" style="margin: auto">
          <div class="cnt_main_contact" style="text-align: center;">
            ...
            <span style="font-size: 14px;display: block;">
              Tu Experencia está  a un paso de publicarse. <br> Te enviamos un correo para  verificar tu email.
            </span>
            <br>
            <span class="text-12 text-muted" style="display: block;">
              Si no ve nuestro correo electrónico en su bandeja de entrada, <br> búsquelo en su carpeta de correo no deseado y marquelo como correo “No basura”. 
            </span>
          </div>
...
<script>
  $(document).ready(function(){
    ...
    let url = '/api/ui/facebook_register';
